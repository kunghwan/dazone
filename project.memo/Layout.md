...
아래의 두 여역 모두 스크롤을 100이상 했을 때만 적용하는 규칙을 가지고 있음

1. 헤더( 100 이상 스크롤 했을 때 상단에 고정 시켜줌)

2. 탑 버튼 (100 이상 스크롤 했을때 등장하고 99 이하로 떨어지면 사라짐)
...
4. 메뉴 아이콘
   ...
   - 화면 커지면 몇 개의 링크 내용만 보여줌 (반응형)
   - sm, md, lg, 사용

5. 로고 클릭 시 홈 화면으로 이동 Link, navi 사용
